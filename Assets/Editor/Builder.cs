...
namespace UnityBuilderAction
{
    static class Builder
    {
        ...
        private static Dictionary<string, string> GetValidatedOptions()
        {
            ...
            if (!validatedOptions.TryGetValue("buildOptions", out var buildOptions))
            {
                Console.WriteLine("Missing argument -buildOptions");
                EditorApplication.Exit(120);
            }

            if (!Enum.IsDefined(typeof(BuildOptions), buildOptions))
            {
                EditorApplication.Exit(121);
            }
